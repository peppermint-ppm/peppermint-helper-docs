---
title: Team
description: Invite teammates to your Peppermint workspace, assign roles and permissions, transfer ownership, and manage who has access.
---
...
|---|---|
| **Owner** | Full access: manage billing, invite/remove members, create and delete studies, configure workspace settings. |
| **Admin** | Create and manage studies, invite/remove members, recruit testers, view and export results. Cannot access billing or update organisation settings. Best for researchers. |
| **Member** | View research results and reports. Cannot create studies, recruit testers, or invite other users. Best for observers and external stakeholders. |
...
:::note
The transfer is not immediate. The designated Admin must accept the ownership invitation. Once they accept, you are automatically assigned an Admin role and remain in the workspace with full Admin permissions.
:::
...
A: The number of team seats depends on your plan. Visit the [Pricing](https://runpeppermint.com/pricing) page to see seat limits for each tier.
