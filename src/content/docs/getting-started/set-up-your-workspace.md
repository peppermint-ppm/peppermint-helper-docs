...
- You need an active Peppermint account at [runpeppermint.com](https://runpeppermint.com).
- Workspace settings can only be updated by the workspace Owner or an Admin.

## How It Works

### Step 1 — Update your workspace identity
...
See: [Invite a team member](/your-account/team)
...
See: [Integrations](https://help.runpeppermint.com/integrations)
