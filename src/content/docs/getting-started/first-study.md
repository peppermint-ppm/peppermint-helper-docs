...
Whether you're a solo researcher running quick, ad-hoc interviews or a product team embedding research into your continuous delivery sprint, the core workflow in Peppermint is the same. This guide walks you through the end-to-end process of launching a study and analysing your results.

## Before You Start

- **Account** — you have an active account at [runpeppermint.com](https://runpeppermint.com).
- **Workspace** — your workspace is configured. See: [Set Up Your Workspace](/getting-started/set-up-your-workspace).
- **Team** — your collaborators are invited and assigned their roles. See: [Team](/your-account/team).
...
:::tip
Testers see a separate customer-facing prompt, not your internal title. To keep your research library organised as you scale, use a naming convention such as: `[Product Area] — [Research Question] — [MM/YYYY]`.
:::

### Step 2: Build your tasks or questions

This is where you build the core content your testers will interact with.
...
:::tip
Multiple team members can collaborate on your draft script. If you cannot see collaboration options, verify your access permissions with your workspace Admin.
:::
...
As testers interact with your study, live session data populates in the **Status** tab. Your study automatically transitions through three internal phases: **Gathering Responses**, **Analysis & Reporting**, and **Quality Assurance**.
...
- **Run Study** — Create a new study from the dashboard.
...
- Save your study as a Draft early — you can check the Mint cost before committing to a configuration.
...
Once your study is live, monitor responses in the Status tab. When complete, share the report link with your stakeholders directly from the Report section.

See also: [Panels](/features/panels) · [Billing & Plan](/your-account/billing)

## FAQs & Common Issues

**Q: How long does it take to collect responses?**  
